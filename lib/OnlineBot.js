...
(function() {
  ...
  OnlineBot = (function(_super) {
    ...
    function OnlineBot() {
      ...
      return OnlineBot.__super__.constructor.apply(this, arguments);
    }
    ...
    OnlineBot.prototype.auth = function(fn) {
      ...
      return this.visit("login", function() {
        ...
        return _this.browser.pressButton('Sign in', function() {
    ...
    OnlineBot.prototype.getLastActivity = function(fn) {
      ...
      return this.visit("account/home", function() {
        ...
        $ = _this.getjQuery();
        activity = [];
        $('.content .box table:nth(1) tr td').each(function() {
