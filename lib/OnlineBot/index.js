...
(function() {
  ...
  OnlineBot = (function(_super) {
    ...
    function OnlineBot() {
      ...
      _ref = OnlineBot.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    OnlineBot.prototype.handleOptions = function() {
      ...
      if ((_base1 = this.options).servers == null) {
        _base1.servers = [];
      }
    ...
    OnlineBot.prototype.getServerStats = function(server_id, fn) {
      ...
      return this.visit("server/stats/" + server_id, function() {
        ...
        $('.content .box').find('img, h3').each(function() {
          var elem, href, period, split, type, _ref1;
          elem = $(this);
          if (elem.is('img')) {
            href = elem.attr('src');
            split = href.split('/')[3].split('-');
            _ref1 = split[split.length - 2].split('_'), period = _ref1[0], type = _ref1[1];
            if (split[0] === 'multi') {
              type = 'multi';
            }
            if (stats[type] == null) {
    ...
    OnlineBot.prototype.servers = function(fn) {
      var _ref1;
      if ((_ref1 = this.options.servers) != null ? _ref1.length : void 0) {
